...
var restaurant = void 0,
  ...
  var name = document.getElementById("restaurant-name");name.innerHTML = restaurant.name;var address = document.getElementById("restaurant-address");address.innerHTML = restaurant.address;var image = document.getElementById("restaurant-img");image.className = "restaurant-img";image.className = "lazyload";image.setAttribute('data-src', DBHelper.imageUrlForRestaurant(restaurant));image.alt = restaurant.name;var restaurant_photograph = restaurant.id;var small_images = restaurant_photograph + "_300.webp";var large_images = restaurant_photograph + "_600.webp";image.srcset = "banners/" + large_images + " 600w" + "," + "banners/" + small_images + " 300w";image.setAttribute('data-src', "banners/" + large_images);image.sizes = "(max-width: 325px) 100vw 50vw";var cuisine = document.getElementById("restaurant-cuisine");cuisine.innerHTML = restaurant.cuisine_type;if (restaurant.operating_hours) {
